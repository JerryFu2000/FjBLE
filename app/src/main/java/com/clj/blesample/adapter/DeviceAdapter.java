...
//Adapter ：因为 ListView 是一个 View ，不能添加子项，因此在呈现数据的时候就需要某种工具将数据呈现在
...
//
//ViewHolder的理解
//  要想使用 ListView 就需要编写一个 Adapter 将数据适配到 ListView上，而为了节省资源提高运行效率，一般
...
public class DeviceAdapter extends BaseAdapter {
    ...
    //2.获取当前Item待绘制的数据源中的相应位置的数据（数据以对象方式存储）
    //3.将数据赋值给item中相应的控件
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (bleDevice != null) {
            ...
            //获取此设备的名称，MAC地址，RSSI值，然后赋值给待更新的View
